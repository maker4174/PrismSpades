		...
		void Draw2D() {
			...
			if (AimDownSightStateSmooth > 0.99F) {
				...
				if (cg_pngScope.IntValue == 1) { // draw classic png scope
					...
					param.drawLines = cg_scopeLines.IntValue == 1;
					param.useTStyle = cg_scopeTStyle.IntValue == 1;
			...
			if (cg_target.IntValue == 1) { // draw default target
				...
				param.lineColor = color;
				param.drawLines = cg_targetLines.IntValue == 1;
				param.useTStyle = cg_targetTStyle.IntValue == 1;
				...
				if (cg_targetDynamic.IntValue == 1) {
				...
				param.drawDot = cg_targetDot.IntValue == 1;
				...
				param.drawOutline = cg_targetOutline.IntValue == 1;
				param.useRoundedStyle = cg_targetOutlineRoundedStyle.IntValue == 1;
