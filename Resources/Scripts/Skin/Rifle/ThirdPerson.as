 ...
 */
 ...
 namespace spades {
	...
	IToolSkin, IThirdPersonToolSkin, IWeaponSkin {
		...
		private Vector3 pivot = Vector3(3.50f, 33.f, 23.f);
		...
		void AddToScene() {
			Matrix4 mat = CreateScaleMatrix(0.014f);
			mat = mat * CreateScaleMatrix(-1.f, -0.8f, 1.f);
			mat = CreateTranslateMatrix(0.35f, -0.5f, -0.05f) * mat;
